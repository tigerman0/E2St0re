...
package='enigma2-plugin-extensions-internet-speedtest'
...
#config
plugin=internet-speedtest
version=1.7
url=https://gitlab.com/eliesat/extensions/-/raw/main/internetspeedtest/internet-speed-test-1.7.tar.gz
