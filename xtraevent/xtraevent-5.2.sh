...
if [ "$pyVersion" = 3 ]; then
url=https://gitlab.com/eliesat/extensions/-/raw/main/xtraevent/xtraevent-py3-5.2.tar.gz
package=/var/volatile/tmp/$plugin-py3-$version.tar.gz
else
url=https://gitlab.com/eliesat/extensions/-/raw/main/xtraevent/xtraevent-py2-5.2.gz
