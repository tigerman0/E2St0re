...
rm -rf /usr/lib/enigma2/python/Plugins/Extensions/TMBD >/dev/null 2>&1
...
version=8.6
if [ "$pyVersion" = 3 ]; then
url=https://gitlab.com/eliesat/extensions/-/raw/main/tmdb/tmdb-py3-8.6.tar.gz
package=/var/volatile/tmp/$plugin-py3-$version.tar.gz
else
url=https://gitlab.com/eliesat/extensions/-/raw/main/tmdb/tmdb-py2-8.6.tar.gz
