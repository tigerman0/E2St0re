#!/bin/sh
if [ -d /usr/lib/enigma2/python/Plugins/Extensions/NOVACAMSUPTVSupreme ]; then
echo "> removing package please wait..."
sleep 3s 
rm -rf /usr/lib/enigma2/python/Plugins/Extensions/NOVACAMSUPTVSupreme > /dev/null 2>&1

status='/var/lib/opkg/status'
package='enigma2-plugin-extensions-novacam-suptv-supreme'
