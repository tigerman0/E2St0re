...
if [ -d /usr/lib/enigma2/python/Plugins/Extensions/Levi45MulticamManager ]; then
echo "> removing package please wait..."
sleep 3s 
rm -rf /usr/lib/enigma2/python/Plugins/Extensions/Levi45MulticamManager > /dev/null 2>&1

status='/var/lib/opkg/status'
package='enigma2-plugin-extensions-levi45multicammanager'
...
#config
plugin=levi45multicammanager
version=10.1-r20
url=https://gitlab.com/eliesat/extensions/-/raw/main/levi45-addon-manager/levi45multicammanager-10.1-r20.tar.gz
